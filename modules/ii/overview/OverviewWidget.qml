                    ...
                    MouseArea {
                        ...
                        onReleased: {
                            ...
                            if (targetWorkspace !== -1 && targetWorkspace !== windowData?.workspace.id) {
                                ...
                                Hyprland.dispatch(`hl.dsp.window.move({ x = "${Math.round(percentageX * root.screen.width)}", y = "${Math.round(percentageY * root.screen.height)}", window = "address:${window.windowData?.address}" })`)
                            }
                        }
                        onClicked: (event) => {
